...
('DEF004', 'Tuyển tập truyện kinh dị', 0, NULL),
('DEF005', 'Doremon tập 30', 20000, NULL),
('DEF006', 'Cambridge Practice Test For Ielts', 140000, NULL),
('DEF007', 'Buổi Chiều Windows', 36000, NULL),
('DEF008', 'Con Chó Săn Nhà Baskerville', 75000, NULL),
('DEF009', 'Looking for Alaska', 230000, NULL),
('DEF010', 'The Count of Monte Cristo', 207000, NULL);
